...
`YOUTUBE_COOKIES` is required when YouTube blocks hosted `yt-dlp` requests with
"Sign in to confirm you're not a bot." Export cookies from a logged-in YouTube
browser session in Netscape cookies.txt format and paste the full file contents
as this Render environment variable.
